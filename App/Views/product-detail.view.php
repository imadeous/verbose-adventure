                        ...
                        <div class="bg-gray-800 rounded-lg overflow-hidden hover:ring-2 hover:ring-indigo-500 transition-all">
                            ...
                            <div class="p-4">
                                ...
                                <div class="mt-4 flex justify-end items-center">
                                    <button class="px-2 py-1 <?= ($variant['stock_quantity'] ?? 0) > 0 ? 'bg-green-500' : 'bg-indigo-700' ?> text-sm text-white rounded hover:bg-indigo-600 transition-colors disabled:opacity-50">
