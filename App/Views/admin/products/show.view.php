                    ...
                    <tbody class="divide-y divide-gray-200">
                        ...
                        ?>
                            <tr class="hover:bg-gray-50 transition">
                                ...
                                <td class="px-4 py-3 whitespace-nowrap">
                                    <div class="flex items-center gap-2">
                                        <a href="<?= url('admin/transactions/income/create?sku=' . urlencode($variantObj->sku)) ?>"
                                            class="text-blue-600 hover:text-blue-700 transition p-1.5 hover:bg-blue-50 rounded"
                                            title="Make Sale">
