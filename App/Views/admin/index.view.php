<div class="mb-8">
    ...
    <div class="mt-6 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <!-- Trend -->
        <div class="bg-blue-50 rounded-xl shadow-md p-5 flex items-center gap-4 border border-blue-200 hover:shadow-lg transition">
            <div class="bg-blue-200 text-blue-600 rounded-lg p-3 flex items-center justify-center">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
        ...
        <div class="col-span-1 bg-blue-50 rounded-xl shadow-md p-5 flex flex-col border border-blue-200 hover:shadow-lg transition">
            ...
            <div class="flex flex-col gap-3">
                ...
                <div class="flex items-center gap-2">
                    ...
                    <span class="ml-auto bg-blue-100 text-blue-700 text-xs px-2 py-1 rounded-full">8 orders</span>
                </div>
                <div class="flex items-center gap-2">
                    <span class="inline-block w-3 h-3 rounded-full bg-blue-300"></span>
                    <span class="font-medium">Miniature Figures</span>
                    <span class="ml-auto bg-blue-50 text-blue-600 text-xs px-2 py-1 rounded-full">7 orders</span>
                </div>
            </div>
        </div>
        <!-- Promo Code Usage -->
                    ...
                    <?php foreach (($recentReviews ?? []) as $review): ?>
                        <div class="bg-blue-100 border border-blue-200 rounded-lg p-4 flex flex-col gap-2 shadow-sm">
                            ...
                            <div class="flex items-center gap-1">
                                ...
                                for ($i = 1; $i <= 5; $i++): ?>
                                    <svg class="w-4 h-4 <?= $i <= $stars ? 'text-blue-400' : 'text-blue-200' ?>" fill="currentColor" viewBox="0 0 20 20">
                ...
                <div class="flex-1 bg-blue-50 rounded-xl shadow-md p-5 border border-blue-200 hover:shadow-lg transition flex flex-col items-start">
                    ...
                    <div class="flex flex-col items-start w-full">
                        <div class="flex items-center gap-2 mb-1">
                            <span class="text-3xl font-extrabold text-blue-900"><?= number_format($overallAvg ?? 0, 1) ?></span>
                            <div class="flex">
                                <?php $stars = round($overallAvg ?? 0);
                                for ($i = 1; $i <= 5; $i++): ?>
                                    <svg class="w-5 h-5 <?= $i <= $stars ? 'text-blue-400' : 'text-blue-200' ?>" fill="currentColor" viewBox="0 0 20 20">
                                        <polygon points="10 15 4 18 5.5 12 1 8 7 7 10 1 13 7 19 8 14.5 12 16 18"></polygon>
                                    </svg>
                                <?php endfor; ?>
                            </div>
                        </div>
                        <div class="text-xs text-blue-400 mb-4">Based on 50 reviews</div>
                            ...
                            <div class="grid grid-cols-1 gap-2">
                                ...
                                ?>
                                    <div class="flex items-center gap-2">
                                        ...
                                        <div class="w-24 bg-blue-200 rounded-full h-2 mx-2">
                                            <div class="<?= $cat['color'] ?> h-2 rounded-full" style="width: <?= $percent ?>%"></div>
                                        </div>
