...
<div class="mb-8">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mt-4">
        ...
        <div class="col-span-1 lg:col-span-3 bg-blue-50 rounded-xl shadow-md p-5 flex flex-col border border-blue-200 hover:shadow-lg transition">
    ...
    <div class="mb-8">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 mt-4 mb-8">
            <!-- Recent Reviews -->
            <div class="col-span-1 bg-blue-50 rounded-xl shadow-md p-5 border border-blue-200 hover:shadow-lg transition flex flex-col overflow-y-scroll">
                <h4 class="text-blue-700 font-semibold mb-4 flex items-center gap-2">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
