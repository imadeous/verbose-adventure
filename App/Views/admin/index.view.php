<div class="mb-8">
    ...
    <div class="mt-6 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <!-- Trend -->
        <div class="bg-white rounded-xl shadow-md p-5 flex items-center gap-4 border border-blue-100 hover:shadow-lg transition">
            <div class="bg-green-100 text-green-500 rounded-lg p-3 flex items-center justify-center">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
...
<div class="mb-8">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8 py-6">
        ...
        <!-- Promo Code Usage -->
        <div class="col-span-1 bg-white rounded-xl shadow-md p-5 flex flex-col border border-blue-100 hover:shadow-lg transition">
            <h4 class="text-pink-500 font-semibold mb-4 flex items-center gap-2">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
        ...
        <!-- Expense Breakdown -->
        <div class="col-span-1 bg-white rounded-xl shadow-md p-5 flex flex-col border border-blue-100 hover:shadow-lg transition">
            <h4 class="text-red-500 font-semibold mb-4 flex items-center gap-2">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
    ...
    <div class="mb-8">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 mt-4 mb-8">
            <!-- Recent Reviews -->
            <div class="col-span-1 bg-white rounded-xl shadow-md p-5 border border-blue-100 hover:shadow-lg transition flex flex-col overflow-y-scroll max-h-[500px]">
                <h4 class="text-green-500 font-semibold mb-4 flex items-center gap-2">
            ...
            <div class="col-span-1 flex flex-col gap-6 h-full">
                ...
                <div class="flex-1 bg-white rounded-xl shadow-md p-5 border border-blue-100 hover:shadow-lg transition flex flex-col items-start">
                    ...
                    <div class="flex flex-col items-start w-full">
                        ...
                        <div class="text-xs text-gray-500 mb-4">Based on <?= $totalReviews ?? 0 ?> reviews</div>
                        <div class="w-full">
