...
<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
    ...
    <div class="bg-white rounded-lg shadow-md p-4 border-l-4 border-blue-500">
        <div class="flex items-center justify-between">
            <div>
                <p class="text-gray-600 text-xs font-semibold uppercase">Unique Customers</p>
                <p class="text-2xl font-bold text-gray-800 mt-1"><?= $stats['unique_customers'] ?></p>
            </div>
    ...
    <div class="bg-white rounded-lg shadow-md p-4 border-l-4 border-green-500">
        <div class="flex items-center justify-between">
            <div>
                <p class="text-gray-600 text-xs font-semibold uppercase">Repeat Customers</p>
                <p class="text-2xl font-bold text-gray-800 mt-1"><?= $stats['repeat_customers'] ?></p>
            </div>
    ...
    <div class="bg-white rounded-lg shadow-md p-4 border-l-4 border-purple-500">
        <div class="flex items-center justify-between">
            <div class="flex-1 min-w-0">
                <p class="text-gray-600 text-xs font-semibold uppercase">Biggest Spender</p>
                <?php if ($stats['biggest_spender']): ?>
                    <p class="text-lg font-bold text-gray-800 mt-1 truncate"><?= e($stats['biggest_spender']['username']) ?></p>
                    <p class="text-xs text-purple-600 font-semibold">MVR <?= number_format($stats['biggest_spender']['total'], 2) ?></p>
                <?php else: ?>
    ...
    <div class="bg-white rounded-lg shadow-md p-4 border-l-4 border-orange-500">
        <div class="flex items-center justify-between">
            <div>
                <p class="text-gray-600 text-xs font-semibold uppercase">Top Platform</p>
                <?php if ($stats['top_platform']): ?>
                    <p class="text-lg font-bold text-gray-800 mt-1 capitalize"><?= e($stats['top_platform']['name']) ?></p>
                    <p class="text-xs text-orange-600 font-semibold"><?= $stats['top_platform']['count'] ?> orders</p>
                <?php else: ?>
                    <p class="text-lg font-bold text-gray-400 mt-1">N/A</p>
                <?php endif; ?>
            </div>
