    ...
    <div class="bg-white shadow rounded-lg p-8">
        ...
        <form action="<?= url('/admin/users/' . $user->id) ?>" method="POST" class="space-y-5" autocomplete="off">
            ...
            <div>
                ...
                <input type="text" name="username" class="w-full border border-gray-300 rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500" value="<?= e($user->username) ?>" required>
            </div>
            <div>
                <label class="block text-sm font-medium text-gray-700 mb-1">Email</label>
                <input type="email" name="email" class="w-full border border-gray-300 rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500" value="<?= e($user->email) ?>" required>
            </div>
            <div>
                <label class="block text-sm font-medium text-gray-700 mb-1">Password <span class="text-xs text-gray-500">(leave blank to keep current)</span></label>
