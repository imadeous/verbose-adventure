    ...
    <div class="container px-5 pt-6 mx-auto">
        ...
        <div class="lg:w-1/2 md:w-2/3 mx-auto">
            <div class="flex flex-wrap -m-2">
                ...
                <div class="p-2 w-full">
                    <div class="relative">
                        <label for="message" class="leading-7 text-sm text-gray-400">Message (optional)</label>
                ...
                <div class="p-2 w-full">
                    <button class="flex mx-auto text-white bg-yellow-500 border-0 py-2 px-8 focus:outline-none hover:bg-yellow-600 rounded text-lg hover:cursor-pointer">Place Order</button>
                </div>
            </div>
        </div>
    </div>
