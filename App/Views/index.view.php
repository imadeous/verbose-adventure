...
<div class="relative isolate">
    ...
    <section class="text-gray-400 bg-gray-900 body-font">
        <div class="container mx-auto flex px-5 py-12 md:flex-row flex-col items-center">
            <div class="lg:flex-grow md:w-2/3 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-8 md:mb-0 items-center text-center">
            ...
            <div class="flex flex-wrap -m-4 text-center">
                <div class="p-4 md:w-1/4 sm:w-1/2 w-full">
                    <div class="border-2 border-gray-800 px-4 py-6 rounded-lg">
                        ...
                        <h2
                            x-data="{ count: 0 }"
                            x-init="let target = <?= $totalOrders ?>; let step = Math.ceil(target / 60); let interval = setInterval(() => { if(count < target) { count += step; if(count > target) count = target; } else { clearInterval(interval); } }, 20);"
                ...
                <div class="p-4 md:w-1/4 sm:w-1/2 w-full">
                    <div class="border-2 border-gray-800 px-4 py-6 rounded-lg">
                        ...
                        <h2
                            x-data="{ count: 0 }"
                            x-init="let target = <?= $totalRevenue ?>; let step = Math.ceil(target / 60); let interval = setInterval(() => { if(count < target) { count += step; if(count > target) count = target; } else { clearInterval(interval); } }, 20);"
                            x-text="count.toLocaleString() + '+'"
                            class="title-font font-medium text-3xl text-white">
                        </h2>
                        <p class="leading-relaxed">Money Made</p>
                    </div>
                </div>
            </div>
        </div>
