            ...
            <div class="flex flex-wrap -m-4 text-center">
                ...
                <div class="p-4 md:w-1/4 sm:w-1/2 w-full">
                    <div class="border-2 border-gray-800 px-4 py-6 rounded-lg">
                        ...
                        <h2
                            x-data="{ count: 0 }"
                            x-init="let target = 2500; let step = Math.ceil(target / 60); let interval = setInterval(() => { if(count < target) { count += step; if(count > target) count = target; } else { clearInterval(interval); } }, 20);"
                            x-text="count.toLocaleString() + '+'"
                            class="title-font font-medium text-3xl text-white">
                        </h2>
