...
class Breadcrumb
{
    ...
    public static function render(): void
    {
        ...
        foreach (self::$breadcrumbs as $index => $breadcrumb) {
            echo '<li class="flex">';
            echo '  <div class="flex items-center">';
            echo '    <svg class="h-full w-6 flex-shrink-0 text-gray-200" viewBox="0 0 24 44" preserveAspectRatio="none" fill="currentColor" aria-hidden="true"><path d="M.293 0l22 22-22 22h1.414l22-22-22-22H.293z" /></svg>';
